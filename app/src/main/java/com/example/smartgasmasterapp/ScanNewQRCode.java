...
public class ScanNewQRCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new_Gas_Text = findViewById(R.id.mannuallyEnterNewGasCode);
        nextGas = findViewById(R.id.next_gas);
        nextGas.setVisibility(View.VISIBLE);
        nextPage = findViewById(R.id.confirm_NewScan_button);
